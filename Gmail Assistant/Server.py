...
CLIENT_SECRET_FILE = 'T:\\CS\\pulse\\CredentialsDesktop.json.json'  # ✅ Make sure this is correct (not .json.json)
API_NAME = 'gmail'
API_VERSION = 'v1'
...
#alternate prompt would be: input_text = (
    "You are an executive assistant. Read the following weekly report and generate a short, bullet-point summary "
    "for a manager. Highlight what the employee accomplished this week, and what their goals are for next week. "
